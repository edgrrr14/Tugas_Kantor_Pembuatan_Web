...
<head>
    <meta charset="UTF-8">
    <title>Laporan Penerbitan Sertifikat Elektronik</title>
    <style>
        @page {
...
<body>
    ...
    <div class="report-title">
        <h1>LAPORAN REKAPITULASI PENGAJUAN PENERBITAN SERTIFIKAT ELEKTRONIK</h1>
    ...
    <table class="meta-summary">
        <tr>
            <td><strong>Total Pengajuan:</strong> {{ $data->count() }} Permohonan</td>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="width: 17%;">Alasan Pengajuan</th>
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="8" class="center" style="padding: 20px; color: #94a3b8;">Tidak ada data pengajuan penerbitan sertifikat.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
